...
describe PagesController do
  ...
  describe "Let an admin" do
    ...
    it "edit the page" do
      ...
      latest_doorkeeper_event.text.should == "Page '[First Page](/pages/first-page)' saved by Testuser, less than a minute"
    end
    ...
    it "create a new page" do
      ...
      latest_doorkeeper_event.text.should == "Page '[A new page for WAT](/pages/a-new-page-for-wat)' created by Testuser, less than a minute"
  end
